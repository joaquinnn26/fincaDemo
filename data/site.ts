export const siteConfig = {
  ...
  social: {
    ...
    airbnb: 'https://www.airbnb.es/rooms/32042426?source_impression_id=p3_1785023394_P3kVP3P9m_kzHqY_',
    googleMaps: 'https://maps.app.goo.gl/YEUGUAHY5cZQKg8BA',
  },
  hours: 'Consultas todos los dias',
  capacities: {
    cabins: '4',
    guests: '14',
    commonAreas: '7',
